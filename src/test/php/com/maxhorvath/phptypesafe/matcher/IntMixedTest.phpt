...
function initiateMixedTypeHintError(int $triggerError, $nonStrictValue)
{
    return true;
}
...
Fatal error: Uncaught exception 'ErrorException' with message 'Argument 1 passed to initiateMixedTypeHintError() must be of type int, string given, called in %s on line %d' in %s:%d
Stack trace:
