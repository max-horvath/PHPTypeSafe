...
function initiateTypeHintError(float $triggerError)
{
    return true;
}
...
Fatal error: Uncaught exception 'ErrorException' with message 'Argument 1 passed to initiateTypeHintError() must be of type float, string given, called in %s on line %d' in %s:%d
Stack trace:
